...
本文档介绍社区 Skill 集合 `claude-scientific-skills`：能力、来源与安装方式。
...
138+ 科学技能的巨型集合，覆盖生物信息、化学、医学、AI 等，现已更名为 Scientific Agent Skills，兼容所有支持开放 Agent Skills 标准的 AI 工具。

```bash
npx skills add https://github.com/K-Dense-AI/claude-scientific-skills
```
